...
Python wrapper for Arizona school enrollment data.

This is a thin rpy2 wrapper around the [azschooldata](https://github.com/almartin82/azschooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `azschooldata` R package installed
...
df_multi = az.fetch_enr_multi([2020, 2021, 2022, 2023, 2024, 2025])
